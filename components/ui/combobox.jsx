...
const ComboboxInput = React.forwardRef(({ className, ...props }, ref) => (
  <ComboboxPrimitive.Input
    ref={ref}
    className={cn(
      "flex h-9 w-full rounded-md bg-transparent text-base placeholder:text-neutral-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm dark:placeholder:text-neutral-400",
      className
    )}
    {...props} />
));
...
const ComboboxBadgeItem = React.forwardRef(({ className, children, ...props }, ref) => (
...
const ComboboxGroup = React.forwardRef(({ className, ...props }, ref) => (
  <ComboboxPrimitive.Group ref={ref} className={cn("overflow-hidden", className)} {...props} />
));
...
const ComboboxItem = React.forwardRef(({ className, children, outset, ...props }, ref) => (
